...
urlpatterns = [
    ...
    path('daily_schedule.html', views.daily_schedule, name='daily_schedule-file'),
    path('social-media-goals', views.social_media_goals, name='social_media_goals'),
    path('social_media_goals.html', views.social_media_goals, name='social_media_goals-file'),
    path('api/respond-challenge', views.respond_challenge, name='respond_challenge'),
]
